...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _ship__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ship */ \"./src/modules/ship.js\");\n\nclass gameboard {\n  constructor() {\n    this.board = this.createBoard();\n  }\n  createBoard() {\n    const board = [];\n    for (let i = 0; i < 100; i++) {\n      const div = {\n        class: 'empty',\n        coordinates: `${i}, 100`\n      };\n      board.push(div);\n    }\n    return board;\n  }\n  placeShip() {\n    const carrier = new _ship__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('Carrier', 5, 0);\n    const battleships = new _ship__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('Battleship', 4, 23);\n    const destroyer = new _ship__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('Destroyer', 3, 56);\n    const submarine = new _ship__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('Submarine', 3, 92);\n    const boat = new _ship__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('Boat', 2, 38);\n    this.board.forEach(div => {\n      carrier.setCoordinates().filter(i => {\n        if (i === div.coordinates) div.class = 'chosen';\n      });\n      battleships.setCoordinates().filter(i => {\n        if (i === div.coordinates) div.class = 'chosen';\n      });\n      destroyer.setCoordinates().filter(i => {\n        if (i === div.coordinates) div.class = 'chosen';\n      });\n      submarine.setCoordinates().filter(i => {\n        if (i === div.coordinates) div.class = 'chosen';\n      });\n      boat.setCoordinates().filter(i => {\n        if (i === div.coordinates) div.class = 'chosen';\n      });\n    });\n    return this.board;\n  }\n}\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (gameboard);\n\n//# sourceURL=webpack://battleship/./src/modules/gameBoard.js?");
